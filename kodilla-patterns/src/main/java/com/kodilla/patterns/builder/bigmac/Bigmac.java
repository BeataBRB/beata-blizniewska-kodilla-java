...
public class Bigmac {
    ...
    private List<IngredientsType> ingredients;
        ...
        public static class BigmacBuilder {
            ...
            public BigmacBuilder sauce(SouceType sauce) {
                this.sauce = sauce;
                return this;
            }
    ...
    private Bigmac(RollType roll, int burgers, SouceType sauce, List<IngredientsType> ingredients) {
        this.roll = roll;
        this.burgers = burgers;
        this.sauce = sauce;
