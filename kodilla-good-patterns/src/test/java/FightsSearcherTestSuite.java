...
import com.kodilla.challeges.Flight.Flight;
import com.kodilla.challeges.Flight.FlightDb;
import com.kodilla.challeges.Flight.FlightsService;
...
public class FightsSearcherTestSuite {
    ...
    private static FlightDb flightsDbMock;
    private static Set<Flight> availableFlights;

    @BeforeClass
    public static void beforeClass() {
        flightsDbMock = mock(FlightDb.class);
